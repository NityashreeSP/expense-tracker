        ...
        <ExpenseFormStyled onSubmit={handleSubmit}>
            ...
            {expenseType === "department" && (
                <div className="input-control">
                    ...
                    >
                        ...
                        <option value="HR">Computer Science Department</option>
                        <option value="Finance">Electronics and Communication</option>
                        <option value="Engineering">Electrical Engineering</option>
                        <option value="Sales">Mechanical Engineering</option>
                    </select>
                </div>
            )}
            ...
            <div className="selects input-control">
                ...
                >
                    ...
                    <option value="groceries">Event</option>
                    <option value="health">Health</option>
                    <option value="subscriptions">Subscriptions</option>
                    <option value="takeaways">Takeaways</option>
                    <option value="clothing">Library</option>  
                    <option value="travelling">Construction</option>  
